      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.__config__.layout === 'rowFormItem'" label="栅格间隔">
            <el-input-number controls-position="right" v-model="activeData.gutter" :min="0" placeholder="栅格间隔" />
          </el-form-item>
          ...
          <el-form-item v-if="isShowMin" label="最小值">
            <el-input-number controls-position="right" v-model="activeData.min" placeholder="最小值" />
          </el-form-item>
          <el-form-item v-if="isShowMax" label="最大值">
            <el-input-number controls-position="right" v-model="activeData.max" placeholder="最大值" />
          </el-form-item>
          ...
          <el-form-item v-if="isShowStep" label="步长">
            <el-input-number controls-position="right" v-model="activeData.step" placeholder="步数" />
          </el-form-item>
          <el-form-item v-if="activeData.__config__.tag === 'el-input-number'" label="精度">
            <el-input-number controls-position="right" v-model="activeData.precision" :min="0" placeholder="精度" />
          </el-form-item>
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          ...
          <el-form-item label="栅格间隔">
            <el-input-number controls-position="right" v-model="formConf.gutter" :min="0" placeholder="栅格间隔" />
          </el-form-item>
