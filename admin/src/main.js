...
let md5Qianxu = 'b14d1e9baeced9bb7525ab19ee35f2d2'; //QIANXU MD5 加密开启vconsole模式
let md5UnQianxu = '3dca2162c4e101b7656793a1af20295c'; //UN_CREMB MD5 加密关闭vconsole模式

if (vconsole !== undefined) {
  if (vconsole === md5UnQianxu && Cookies.has(cookieName)) Cookies.remove(cookieName);
} else vconsole = Cookies.get(cookieName);

if (vconsole !== undefined && vconsole === md5Qianxu) {
  Cookies.set(cookieName, md5Qianxu, 3600);
