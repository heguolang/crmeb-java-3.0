<template>
  <el-dialog :visible.sync="modals" title="发送货" class="order_box" :before-close="handleClose" width="900px">
    <el-form ref="formItem" :model="formItem" label-width="110px" @submit.native.prevent :rules="rules">
      <el-form-item label="快递公司：" prop="expressCode">
        <el-select style="width: 100%" v-model="formItem.deliveryId" filterable>
          <el-option
      ...
      <el-form-item label="快递单号：" prop="waybillId">
        <el-input v-model="formItem.waybillId" placeholder="请输入快递单号"></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer">
