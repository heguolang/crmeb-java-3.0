#!/usr/bin/env bash
# CRMEB 本地 Maven 包装脚本（MSYS/Git-Bash 下 mvn 脚本会因路径转换失败，故直调 classworlds）
# 用法: bash local-dev/mvnw.sh -DskipTests -pl crmeb-common,crmeb-admin -am clean package
export PATH="/usr/bin:/bin:/c/Windows/System32:$PATH"
export MSYS_NO_PATHCONV=1
JAVA_EXE="D:/env/java/jdk8u504-b01/bin/java.exe"
MVN_HOME="D:\\env\\apache-maven-3.9.16"
PROJ_DIR="D:\\crmeb-java-3.0\\crmeb"
exec "$JAVA_EXE" \
