...
echo [2/3] 导入基库 Crmeb_v3.0.sql （约几分钟，请勿中断）...
...
if /I "%MODE%"=="full" (
  echo [可选] 导入演示业务数据 crmeb_full_data_export.sql ...
  if exist "%FULL_DATA%" (
...
echo 请重启 Crmeb-admin / Crmeb-front，并清 Redis 配置缓存（如有）
echo.
pause
exit /b 0
