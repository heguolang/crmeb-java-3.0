...
public class StockController {
    ...
    public CommonResult<CommonPage<com.qxkj.common.model.stock.StockChangeLog>> changeLogList(
            @RequestParam(value = "uid", required = false) Integer uid,
    ...
    public CommonResult<HashMap<String, Object>> productStockType(@RequestParam Integer productId) {
        ...
        com.qxkj.common.model.stock.StockProductRel rel = stockService.getProductRel(productId);
    ...
    public CommonResult<java.util.List<com.qxkj.common.model.stock.StockExchangeConfig>> exchangeConfigList(
            @RequestParam Integer productId) {
    ...
    public CommonResult<java.util.List<com.qxkj.common.model.stock.StockExchangeTarget>> exchangeTargets(
            @RequestParam Integer productId,
    ...
    public CommonResult<String> saveSetting(@RequestBody HashMap<String, Object> settingMap) {
        try {
            ...
            if (laddersObj != null) {
                ...
                List<com.qxkj.common.model.stock.StockLadder> ladders =
                        com.alibaba.fastjson.JSON.parseArray(
                                com.alibaba.fastjson.JSON.toJSONString(laddersObj),
                                com.qxkj.common.model.stock.StockLadder.class);
