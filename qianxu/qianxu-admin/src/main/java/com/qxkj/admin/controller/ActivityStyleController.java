...
import com.qxkj.common.request.ActivityStyleRequest;
import com.qxkj.common.request.ActivityStyleSearchRequest;
import com.qxkj.common.request.ActivityStyleUpdateStatusRequest;
...
public class ActivityStyleController {
    ...
    public CommonResult<String> save(@RequestBody @Validated ActivityStyleRequest activityStyleRequest) {
        ...
        activityStyle.setStarttime(QianxuDateUtil.strToDate(activityStyleRequest.getStarttime(), DateConstants.DATE_FORMAT));
        activityStyle.setEndtime(QianxuDateUtil.strToDate(activityStyleRequest.getEndtime(), DateConstants.DATE_FORMAT));
