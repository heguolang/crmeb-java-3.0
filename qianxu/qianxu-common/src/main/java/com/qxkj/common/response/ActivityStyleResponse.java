...
public class ActivityStyleResponse {
    ...
    public void setRunningStatus(Date starttime, Date endtime, Date currenttime) {
        // isEnd = -1 = 已结束
        int isEnd = QianxuDateUtil.compareDate(QianxuDateUtil.dateToStr(endtime, DateConstants.DATE_FORMAT),
                QianxuDateUtil.dateToStr(currenttime, DateConstants.DATE_FORMAT),
                DateConstants.DATE_FORMAT);
        // isIng1 = 1 和下面并且链接
        int isIng1 = QianxuDateUtil.compareDate(QianxuDateUtil.dateToStr(endtime, DateConstants.DATE_FORMAT),
                QianxuDateUtil.dateToStr(currenttime, DateConstants.DATE_FORMAT),
                DateConstants.DATE_FORMAT);
        // isIng2 = -1 和上面并且链接
        int isIng2 = QianxuDateUtil.compareDate(QianxuDateUtil.dateToStr(starttime, DateConstants.DATE_FORMAT),
                QianxuDateUtil.dateToStr(currenttime, DateConstants.DATE_FORMAT),
                DateConstants.DATE_FORMAT);
        // isPer = 1 = 未开始
        int isPer = QianxuDateUtil.compareDate(QianxuDateUtil.dateToStr(starttime, DateConstants.DATE_FORMAT),
                QianxuDateUtil.dateToStr(currenttime, DateConstants.DATE_FORMAT),
                DateConstants.DATE_FORMAT);
