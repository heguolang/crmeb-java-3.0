...
import com.qxkj.common.vo.WxRefundVo;
...
public class WxPayUtil {
    ...
    public static HashMap<String, Object> processResponseXml(String xmlStr) throws Exception {
        ...
        if (respData.containsKey(RETURN_CODE)) {
            ...
            throw new QianxuException(String.format("No `return_code` in XML: %s", xmlStr));
        }
        ...
        if (return_code.equals(Constants.FAIL)) {
            ...
            throw new QianxuException(String.format("return_code value %s is invalid in XML: %s", return_code, xmlStr));
        }
    }
    ...
    public static String getNonceStr() {
        return DigestUtils.md5Hex(QianxuUtil.getUuid() + QianxuUtil.randomCount(111111, 666666));
    }
