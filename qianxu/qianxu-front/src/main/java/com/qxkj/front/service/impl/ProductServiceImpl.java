...
import com.qxkj.common.request.ProductListRequest;
...
import com.qxkj.front.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDetailResponse getDetail(Integer id, String type) {
        ...
        if (!storeProductGroupService.canViewProduct(user, id)) {
            throw new com.qxkj.common.exception.QianxuException(storeProductGroupService.getDenyTip());
        }
