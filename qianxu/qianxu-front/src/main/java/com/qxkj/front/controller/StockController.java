...
public class StockController {
    ...
    public CommonResult<HashMap<String, Object>> productList(
        ...
        if (agent == null || agent.getStatus() != 1) {
            throw new com.qxkj.common.exception.QianxuException("您还不是订货代理或已被禁用");
        }
        ...
        for (com.qxkj.common.model.stock.StockProductRel rel : stockService.getStockProductRelList()) {
    ...
    public CommonResult<HashMap<String, Object>> payOrder(@RequestBody @Validated StockPayRequest request,
        ...
        return CommonResult.success(stockPayService.pay(currentUid(), request, QianxuUtil.getClientIp(httpRequest)));
    }
    ...
    public CommonResult<HashMap<String, Object>> payExchangeDiff(@RequestBody @Validated StockRequests.StockExchangeDiffPayRequest request,
        ...
        if ("weixin".equalsIgnoreCase(request.getPayType())) {
            return CommonResult.success(stockPayService.payExchangeDiffWeixin(currentUid(), request.getExchangeId(),
                    request.getPayChannel(), QianxuUtil.getClientIp(httpRequest)));
        }
    ...
    public CommonResult<List<com.qxkj.common.model.stock.StockVirtualStock>> myVirtualStock() {
