...
import com.qxkj.common.constants.YlyConstants;
...
import com.qxkj.common.response.YlyAccessTokenResponse;
import com.qxkj.common.utils.RedisUtil;
import com.qxkj.service.service.SystemConfigService;
import com.qxkj.service.util.yly.RequestMethod;
...
public class YlyUtil {
    ...
    public void instant() {
        ...
        try {
            ...
            if(StringUtils.isBlank(client_id) || StringUtils.isBlank(client_secret)
                ...
                throw new QianxuException("易联云配置数据不完整");
            }
    ...
    public void ylyVoice() throws Exception {
        ...
        RequestMethod.getInstance().printerSetVoice(
                ...
                machine_code,"[\"黔序商城 来新单了\",9,0]","false",
                "0","ORDER xxx");
        logger.info("设置语音成功");
    }
...
//        ylyPrintRequest.setBusinessName("黔序商城订单");
