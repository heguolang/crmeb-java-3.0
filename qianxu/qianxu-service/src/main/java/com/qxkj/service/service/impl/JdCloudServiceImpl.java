...
import com.qxkj.service.service.JdCloudService;
...
public class JdCloudServiceImpl implements JdCloudService {
    ...
    public void createBucket(String bucketName) {
        ...
        try {
            ...
            throw new QianxuException("京东云存储创建存储空间失败:" + e.getMessage());
        } finally {
            s3.shutdown();
        }
    }
    ...
    /**
     * 获取文件URL
     * eg: https://qianxu-ceshi.s3.cn-north-1.jdcloud-oss.com/w5.webp
     * @param bucket 存储桶名称
     * @param fileName 文件名称
     */
    @Override
    public String getUrl(String bucket, String fileName) {
        ...
        try {
            ...
            throw new QianxuException("京东云获取文件地址失败:" + e.getMessage());
        } finally {
            s3.shutdown();
        }
        return urlPath;
