...
public interface StockRewardService {
    ...
    void settleExchangeDiffReward(com.qxkj.common.model.stock.StockExchange exchange);
    ...
    /** 我的消息列表 */
    CommonPage<com.qxkj.common.model.stock.StockNotice> getMyNoticeList(Integer uid, PageParamRequest page);
