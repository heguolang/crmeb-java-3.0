...
import com.qxkj.common.model.acticitystyle.ActivityStyle;
import com.qxkj.common.model.product.StoreProduct;
import com.qxkj.common.page.CommonPage;
import com.qxkj.common.request.ActivityStyleSearchRequest;
import com.qxkj.common.request.PageParamRequest;
import com.qxkj.common.response.ActivityStyleResponse;
import com.qxkj.common.utils.QianxuDateUtil;
import com.qxkj.common.utils.QianxuUtil;
import com.qxkj.common.utils.RedisUtil;
import com.qxkj.service.dao.ActivityStyleDao;
import com.qxkj.service.service.ActivityStyleService;
...
public class ActivityStyleServiceImpl extends ServiceImpl<ActivityStyleDao, ActivityStyle> implements ActivityStyleService {
    ...
    public PageInfo<ActivityStyleResponse> getList(ActivityStyleSearchRequest request, PageParamRequest pageParamRequest) {
        ...
        Date currentDate = QianxuDateUtil.nowDateTime();
...
//            lambdaQueryWrapper.ge(ActivityStyle::getStarttime, request.getStarttime()).le(ActivityStyle::getEndtime, request.getEndtime());
    ...
    public List<ActivityStyle> getListBeforeBeginTime(boolean type) {
        ...
        lambdaQueryWrapper.le(ActivityStyle::getStarttime, QianxuDateUtil.nowDateTime(DateConstants.DATE_FORMAT));
        lambdaQueryWrapper.ge(ActivityStyle::getEndtime, QianxuDateUtil.nowDateTime(DateConstants.DATE_FORMAT));
        List<ActivityStyle> activityStyles = dao.selectList(lambdaQueryWrapper);
        ...
        if (!type) {
            redisUtil.set(ProductConstants.PRODUCT_ACTIVITY_STYLE_BORDER, activityStyles,
                    Long.parseLong(qianxuConfig.getActivityStyleCachedTime().toString()), TimeUnit.SECONDS);
                    ...
                    if (StrUtil.isBlank(product.getActivityStyle())) {
                        for (String pcid : platCategoryIds) {
                            if (ObjectUtil.isNotEmpty(product.getCateId())) {
                                List<Integer> proCateIdList = QianxuUtil.stringToArray(product.getCateId());
    ...
    private void sortByActivityStyleByUpdateTime(List<ActivityStyle> toSortActivityStyleByUpdateTime) {
        Collections.sort(toSortActivityStyleByUpdateTime, new Comparator<ActivityStyle>() {
            ...
            public int compare(ActivityStyle o1, ActivityStyle o2) {
                return QianxuDateUtil.compareDate(
                        QianxuDateUtil.dateToStr(o2.getUpdatetime(), DateConstants.DATE_FORMAT),
                        QianxuDateUtil.dateToStr(o1.getUpdatetime(), DateConstants.DATE_FORMAT), DateConstants.DATE_FORMAT);
            }
        });
    }
}
