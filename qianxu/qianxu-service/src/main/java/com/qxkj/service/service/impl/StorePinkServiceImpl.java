...
import com.qxkj.common.request.OrderRefundApplyRequest;
...
import com.qxkj.service.dao.StorePinkDao;
    ...
    */
    ...
    public PageInfo<StorePinkAdminListResponse> getList(StorePinkSearchRequest request) {
        ...
        List<StorePinkAdminListResponse> list = storePinks.stream().map(pink -> {
            ...
            storePinkResponse.setAddTime(QianxuDateUtil.timestamp2DateStr(pink.getAddTime(), Constants.DATE_FORMAT));
            storePinkResponse.setStopTime(QianxuDateUtil.timestamp2DateStr(pink.getStopTime(), Constants.DATE_FORMAT));
