...
import com.qxkj.common.request.StoreSeckillMangerRequest;
import com.qxkj.common.request.StoreSeckillMangerSearchRequest;
import com.qxkj.common.response.StoreSeckillManagerResponse;
import com.github.pagehelper.PageHelper;
import com.qxkj.common.utils.QianxuDateUtil;
import com.qxkj.common.model.seckill.StoreSeckillManger;
import com.qxkj.service.dao.StoreSeckillMangerDao;
    ...
    */
    ...
    public Boolean update(Integer id, StoreSeckillMangerRequest storeSeckillMangerRequest) {
        ...
        if(existTimes.size() > 1){
            throw new QianxuException("当前时间段的秒杀配置已存在");
    ...
    private void setTimeRangeFromRequest(@Validated @RequestBody StoreSeckillMangerRequest storeSeckillMangerRequest, StoreSeckillManger storeSeckillManger) {
        if(!storeSeckillMangerRequest.getTime().contains(",")){
            throw new QianxuException("时间参数不正确 例如:01:00,02:00");
        }
