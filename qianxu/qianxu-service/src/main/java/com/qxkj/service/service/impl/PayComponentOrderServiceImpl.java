...
import com.qxkj.service.dao.PayComponentOrderDao;
import com.qxkj.service.service.PayComponentOrderProductService;
import com.qxkj.service.service.PayComponentOrderService;
import com.qxkj.service.service.WechatVideoAftersaleService;
import com.qxkj.service.service.WechatVideoOrderService;
...
public class PayComponentOrderServiceImpl extends ServiceImpl<PayComponentOrderDao, PayComponentOrder> implements PayComponentOrderService {
    ...
    public String create(ShopOrderAddVo shopOrderAddVo) {
        ...
        order.setCreateTime(QianxuDateUtil.nowDateTime());
...
//            orderProduct.setSkuId();
            ...
            orderProduct.setCreateTime(QianxuDateUtil.nowDateTime());
            return orderProduct;
        ...
        if (!execute) {
            throw new QianxuException("保存组件订单失败");
        }
    ...
    public void createAfterSale(String orderNo) {
        ...
        shopAftersaleAddVo.setCreateTime(QianxuDateUtil.nowDate());
        ...
        if (!add) {// 创建售后失败
            ...
            throw new QianxuException("视频号订单创建售后失败，orderNo=" + orderNo);
        }
        // 创建售后成功,更新售后
        ...
        if (!update) {
            ...
            throw new QianxuException("视频号订单更新售后失败，orderNo=" + orderNo);
        }
    }
}
