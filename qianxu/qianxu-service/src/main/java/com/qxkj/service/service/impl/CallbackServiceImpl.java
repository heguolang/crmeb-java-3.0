...
import com.qxkj.common.constants.AlipayConfig;
...
import com.qxkj.common.vo.AttachVo;
import com.qxkj.common.vo.CallbackVo;
...
public class CallbackServiceImpl implements CallbackService {
    ...
    private com.qxkj.service.service.StockOrderService stockOrderService;
    ...
    public String weChat(String xmlInfo) {
        ...
        try{
            ...
            //解析xml
            CallbackVo callbackVo = QianxuUtil.mapToObj(map, CallbackVo.class);
            ...
            if (ObjectUtil.isNull(user)) {
                //用户信息错误
                throw new QianxuException("用户信息错误！");
            }
            ...
            if (!Constants.SERVICE_PAY_TYPE_ORDER.equals(attachVo.getType())
                ...
                throw new QianxuException("未知的支付类型！");
            }
            // 订单
            if (Constants.SERVICE_PAY_TYPE_ORDER.equals(attachVo.getType())) {
                ...
                if (ObjectUtil.isNull(storeOrder)) {
                    ...
                    throw new QianxuException("wechat pay error : 订单信息不存在==》" + callbackVo.getOutTradeNo());
                }
                ...
                if (ObjectUtil.isNull(wechatPayInfo)) {
                    ...
                    throw new QianxuException("wechat pay error : 微信订单信息不存在==》" + callbackVo.getOutTradeNo());
                }
            ...
            if ("exchange".equals(attachVo.getType())) {
                ...
                if (!ok) {
                    ...
                    throw new QianxuException("wechat pay error : 换货单不存在==》" + callbackVo.getOutTradeNo());
                }
            }
            // 订货单
            if (Constants.SERVICE_PAY_TYPE_STOCK.equals(attachVo.getType())) {
                ...
                if (ObjectUtil.isNull(stockOrder)) {
                    ...
                    throw new QianxuException("wechat pay error : 订货单不存在==》" + callbackVo.getOutTradeNo());
                }
            ...
            if (Constants.SERVICE_PAY_TYPE_RECHARGE.equals(attachVo.getType())) {
                ...
                if (!rechargePayAfter) {
                    ...
                    throw new QianxuException("wechat pay error : 数据保存失败==》" + callbackVo.getOutTradeNo());
                }
            }
            sb.append("<return_code><![CDATA[SUCCESS]]></return_code>");
            sb.append("<return_msg><![CDATA[OK]]></return_msg>");
...
//                String orderType = jsonObject.getString("type");
    ...
    private String getSignKey(String appid) {
        ...
        if (StrUtil.isBlank(publicAppid) && StrUtil.isBlank(miniAppid) && StrUtil.isBlank(appAppid)) {
            throw new QianxuException("pay_weixin_appid或pay_routine_appid不能都为空");
        }
