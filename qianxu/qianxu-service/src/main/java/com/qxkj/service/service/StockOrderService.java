...
public interface StockOrderService {
    ...
    /** 我的虚拟库存列表（剩余可提货数量>0） */
    List<com.qxkj.common.model.stock.StockVirtualStock> getMyVirtualStock(Integer uid);
    ...
    /** 换货设置列表（按商品，含整品与各规格） */
    List<com.qxkj.common.model.stock.StockExchangeConfig> getExchangeConfigList(Integer productId);
    ...
    List<com.qxkj.common.model.stock.StockExchangeTarget> getExchangeTargetList(Integer productId, String skuKey);
    ...
    CommonPage<StockOrder> getMyOrderList(Integer uid, Integer status, com.qxkj.common.request.PageParamRequest page);
     ...
     */
    CommonPage<StockOrder> getSubAgentOrderList(Integer uid, Integer subUid, Integer status, com.qxkj.common.request.PageParamRequest page);
    ...
    /** 我需要审核的订单（直接下级提交） */
    CommonPage<StockOrder> getAuditOrderList(Integer uid, Integer status, com.qxkj.common.request.PageParamRequest page);

    /** 提交换货申请 */
    Boolean applyExchange(Integer uid, StockRequests.StockExchangeApplyRequest request);

    /** 我的换货单列表（我作为申请人提交的） */
    CommonPage<StockExchange> getMyExchangeList(Integer uid, com.qxkj.common.request.PageParamRequest page);

    /**
     * 待我审核的换货单列表（我作为直接上级，下级的实体换货申请）
     * status 为 null 时只看「待上级审核」；传 -2 表示我经手过的全部换货单
     */
    CommonPage<StockExchange> getExchangeAuditList(Integer uid, Integer status, com.qxkj.common.request.PageParamRequest page);
    ...
    /** 全部订货单列表 */
    CommonPage<StockOrder> getAdminOrderList(Integer uid, String orderNo, Integer status, Integer payStatus, com.qxkj.common.request.PageParamRequest page);
     ...
     * 等待匹配上级的订单列表（后台）
     */
    CommonPage<StockOrder> getWaitMatchOrderList(com.qxkj.common.request.PageParamRequest page);
    ...
    /** 换货单列表 */
    CommonPage<StockExchange> getAdminExchangeList(Integer status, com.qxkj.common.request.PageParamRequest page);
